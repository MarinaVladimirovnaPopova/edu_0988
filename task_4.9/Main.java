...
class Person { // Описание того, как должен выглядить человек
    ...
    void info() {
        ...
        if (this.mother != null) { // Проверка существования матери
            ...
            if (this.mother.mother != null) { // Проверка существования мамы матери (бабушка по маминой линии)
                info += "Бабушку по маминой линии зовут " + this.mother.mother.name + "\n";
                }
            }
            if (this.father != null) {
                info += "Моего папу зовут " + this.father.name + "\n";
                if (this.father.father != null) { // Проверка существования отца папы  (дедушки по папиной линии)
                    info += "Дедушку по папиной линии зовут " + this.father.father.name + "\n";
                }
                if (this.father.mother != null) { // Проверка существования мамы отца (бабушка по папиной линии)
